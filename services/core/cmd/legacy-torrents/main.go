...
func main() {
	...
	if *action == "status" {
		...
		logger.Info(
			...
			"seedbox_source_rows", result.SeedboxSourceRows,
			"seedbox_enabled_rows", result.SeedboxEnabledRows,
			"seedbox_expected_bindings", result.SeedboxExpectedBindings,
			"seedbox_imported_bindings", result.SeedboxImportedBindings,
			"seedbox_policy_sequence", result.SeedboxPolicySequence,
			"personal_state_receipts", result.PersonalStateReceipts,
			"bookmark_source_rows", result.BookmarkSourceRows,
			"bookmark_evidence_rows", result.BookmarkEvidenceRows,
			...
			"invitation_evidence_rows", result.InvitationEvidenceRows,
			...
			"invite_reward_source_rows", result.InviteRewardSourceRows,
			"invite_reward_users", result.InviteRewardUsers,
			"invitation_reward_evidence", result.InvitationRewardEvidence,
...
func runCutoverAcceptance(
	...
	report, err := legacytorrents.InspectCutoverAcceptance(
		...
		legacytorrents.CutoverAcceptanceConfig{
			...
			TrackerRuntimePolicyPath:   acceptanceSettings.RuntimePolicyPath,
			...
			TrackerRuntimePolicyMaxAge: acceptanceSettings.RuntimePolicyMaxAge,
	...
	logger.Info(
		...
		"bookmark_source_rows", report.BookmarkSourceRows,
		"bookmark_applied_rows", report.BookmarkAppliedRows,
		"bookmark_unresolved_rows", report.BookmarkUnresolvedRows,
		"invitation_source_rows", report.InvitationSourceRows,
		"invitation_relationships", report.InvitationRelationships,
		"invitation_unresolved_rows", report.InvitationUnresolvedRows,
		"harem_reward_source_rows", report.HaremRewardSourceRows,
		"harem_reward_users", report.HaremRewardUsers,
		"invite_reward_source_rows", report.InviteRewardSourceRows,
		"invite_reward_users", report.InviteRewardUsers,
		...
		"seedbox_source_rows", report.SeedboxSourceRows,
		"seedbox_enabled_rows", report.SeedboxEnabledRows,
		"seedbox_binding_rows", report.SeedboxBindingRows,
		"seedbox_policy_sequence", report.SeedboxPolicySequence,
		"seedbox_upload_factor_basis_points", report.SeedboxUploadFactorBasisPoints,
		"seedbox_download_factor_basis_points", report.SeedboxDownloadFactorBasisPoints,
		"seedbox_speed_limit_bytes_per_second", report.SeedboxSpeedLimitBytesPerSecond,
		"standard_speed_limit_bytes_per_second", report.StandardSpeedLimitBytesPerSecond,
